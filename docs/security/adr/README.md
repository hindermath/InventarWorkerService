...
Sicherheitsbezug fuer InventarWorkerService. Jede Entscheidung wird als
einzelne Datei im Format `ADR-NNN-titel.md` abgelegt.

*This directory contains security-related architecture decisions
for InventarWorkerService. Each decision is stored as an individual file
...
[DE-Zusammenfassung: Index der Security Architecture Decision Records fuer InventarWorkerService.]
-->
