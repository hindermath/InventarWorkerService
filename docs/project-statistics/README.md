...
sichtbare Aenderungsaktivitaet von InventarWorkerService. Die
...
- Keine projektspezifischen Ausschluesse aus Profil 2 vorhanden.
...
Use UTC and 52 weeks with reference estimates disabled. No legacy project-specific exclusions exist. Do not reinterpret authored phase totals as
