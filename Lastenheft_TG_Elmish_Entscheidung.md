...
```text
/speckit-specify Nutze Lastenheft_TG_Elmish_Entscheidung.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Dependency- und Architekturentscheidungs-Lauf im Repository InventarWorkerService.
