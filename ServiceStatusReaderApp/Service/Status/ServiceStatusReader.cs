...
public class ServiceStatusReader
{
    ...
    public InventarWorkerService.Models.ServiceStatus? ReadStatus()
    {
        try
        {
            ...
            return JsonSerializer.Deserialize<InventarWorkerService.Models.ServiceStatus>(json, _jsonOptions);
        }
        catch (Exception ex)
        {
