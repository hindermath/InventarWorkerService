...
```text
/speckit-specify Nutze Lastenheft_TG_Migration_InventarViewerApp.md als verbindliche Eingabedatei. Erstelle die Feature-Spezifikation fuer einen Terminal.Gui-Migrations- und Kompatibilitaetslauf im Repository InventarWorkerService.
